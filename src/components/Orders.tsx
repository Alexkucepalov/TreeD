                        ...
                        <div className={styles.statusSection}>
                          ...
                          <div className={styles.statusValue}>
                            <div className={styles.statusTags}>
                              {(() => {
                                let statusColor: 'light-yellow' | 'green' | 'peach' = 'light-yellow';
                                if (order.status === 'Готово') {
                                  statusColor = 'green';
                                } else if (order.status === 'Отправка') {
                                  statusColor = 'peach';
                                } else if (order.status === 'В процессе') {
                                  statusColor = 'light-yellow';
                                }
                                return <Chips color={statusColor} size="small">{order.status}</Chips>;
                              })()}
                              {order.statusText && (
